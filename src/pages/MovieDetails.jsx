    ...
    <>
      ...
      <div className='w-full h-[70vh] text-white'>
        <div className='h-full w-full'>
          ...
          <img src={`https://image.tmdb.org/t/p/original/${movie?.backdrop_path}`} alt={movie?.title} className='w-full h-[40vh] lg:h-[90vh] object-cover' />
          <div className='flex justify-center gap-7 absolute w-full px-5 md:px-20 top-[30%]'>
            <div>
              <img className='hidden md:flex rounded-md w-[15.6rem] object-contain' src={imageUrl} alt={movie.title} />
            </div>
            <div className='md:max-w-[23rem] lg:max-w-[45rem] text-left'>
              <p className='text-[3rem] lg:text-[4rem] mb-[1rem] font-bold leading-tight'>{movie.title}</p>
